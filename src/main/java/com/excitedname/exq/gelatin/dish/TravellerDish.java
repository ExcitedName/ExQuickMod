...
public class TravellerDish extends Item {
	...
	public float SecondPotionEffectProbability;
		...
		public TravellerDish setFirstPotionEffect(int par1, int par2, int par3, float par4){
		...
		public TravellerDish setSecondPotionEffect(int par1, int par2, int par3, float par4){
