...
public class NightVisionCube extends Item {
	...
	//Declaration 
		...
		public NightVisionCube() {
			
			this.setUnlocalizedName("Night Vision Cube");
			this.setTextureName("Night Vision Cube");
			this.setCreativeTab(Tabs.GelatinTab);
			this.setFirstPotionEffect(Potion.nightVision.id, 20, 0, 1F);
		}
		...
		public NightVisionCube setFirstPotionEffect(int par1, int par2, int par3, float par4){
