...
public class IronSkinCube extends Item {
	...
	//Declaration 
		...
		public IronSkinCube() {
			...
			this.setUnlocalizedName("Iron Skin Cube");
			this.setTextureName("Iron Skin Cube");
		...
		public IronSkinCube setFirstPotionEffect(int par1, int par2, int par3, float par4){
