...
public class WarriorCube extends Item {
	...
	public float FirstPotionEffectProbability;
		...
		public WarriorCube() {
			...
			this.setUnlocalizedName("Warrior Cube");
			this.setTextureName("Warrior Cube");
	    ...
	    public WarriorCube setFirstPotionEffect(int par1, int par2, int par3, float par4){
