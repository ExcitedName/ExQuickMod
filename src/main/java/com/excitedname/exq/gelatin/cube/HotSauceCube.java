...
public class HotSauceCube extends Item {
	...
	public float ThirdPotionEffectProbability;
		...
		public HotSauceCube() {
			...
			this.setUnlocalizedName("Hot Sauce Cube");
			this.setTextureName("Hot Sauce Cube");
...
public HotSauceCube setFirstPotionEffect(int par1, int par2, int par3, float par4){
...
public HotSauceCube setSecondPotionEffect(int par1, int par2, int par3, float par4){
...
public HotSauceCube setThirdPotionEffect(int par1, int par2, int par3, float par4){
