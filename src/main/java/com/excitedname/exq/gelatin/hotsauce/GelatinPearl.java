...
public class GelatinPearl extends Item {

	
		public GelatinPearl() {
			
			this.setUnlocalizedName("Gelatin Pearl");
			this.setTextureName("Gelatin Pearl");
		...
		public ItemStack onItemRightClick(ItemStack par1GelatinPearl, World par2World, EntityPlayer par3Player)
	    {
	        ...
	        {
	        	par2World.spawnEntityInWorld(new EntityGelatinPearl(par2World, par3Player));
	        }
