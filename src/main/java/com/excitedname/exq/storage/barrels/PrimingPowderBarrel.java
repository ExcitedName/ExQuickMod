...
public class PrimingPowderBarrel extends Item {

	public PrimingPowderBarrel(){
		
		this.setUnlocalizedName("Priming Powder Barrel");
		this.setTextureName("Priming Powder Barrel");
