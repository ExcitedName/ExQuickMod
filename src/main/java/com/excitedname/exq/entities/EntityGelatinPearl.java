...
public class EntityGelatinPearl extends EntityThrowable {
	
	public EntityGelatinPearl(World par1World)
    {
        super(par1World);
    }

    public EntityGelatinPearl(World par1World, EntityLivingBase par2LivingBase)
    {
    ...
    protected void onImpact(MovingObjectPosition par1Position) {
        ...
        if (!this.worldObj.isRemote)
        {
            if (this.getThrower() != null && this.getThrower() instanceof EntityPlayerMP)
            {
                ...
                {
                    EnderTeleportEvent event = new EnderTeleportEvent(entityplayermp, this.posX, this.posY, this.posZ, 3.0F);
