...
public class EntityGelatinPearlEnhanced extends EntityThrowable {
	
	public EntityGelatinPearlEnhanced(World par1World)
    {
        super(par1World);
    }

    public EntityGelatinPearlEnhanced(World par1World, EntityLivingBase par2LivingBase)
    {
