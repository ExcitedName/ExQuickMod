...
public class HotSauceSolution extends Item {
...
public HotSauceSolution setFirstPotionEffect(int par1, int par2, int par3, float par4){
...
public HotSauceSolution setSecondPotionEffect(int par1, int par2, int par3, float par4){
...
public HotSauceSolution setThirdPotionEffect(int par1, int par2, int par3, float par4){
