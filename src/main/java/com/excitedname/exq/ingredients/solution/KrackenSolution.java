...
public class KrackenSolution extends Item {
	...
	public KrackenSolution() {
				
		this.setUnlocalizedName("Kracken Solution");
		this.setTextureName("Kracken Solution");
		this.setCreativeTab(Tabs.GelatinTab);
		this.setFirstPotionEffect(Potion.waterBreathing.id, 20, 0, 1F);			
		this.setSecondPotionEffect(Potion.nightVision.id, 20, 0, 1F);
	}
    ...
    public KrackenSolution setFirstPotionEffect(int par1, int par2, int par3, float par4){
	...
	public KrackenSolution setSecondPotionEffect(int par1, int par2, int par3, float par4){
