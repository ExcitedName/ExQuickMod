...
public class TravellerSolution extends Item {
    ...
    public TravellerSolution setFirstPotionEffect(int par1, int par2, int par3, float par4){
	...
	public TravellerSolution setSecondPotionEffect(int par1, int par2, int par3, float par4){
