...
public class GlassJar extends Item {
	...
	public GlassJar(Block Full){
		...
		this.setUnlocalizedName("Glass Jar");
		this.setTextureName("Glass Jar");
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            if (flag)
            {
                ...
                if (material == Material.water && l == 0)
                {
                    ...
                    return this.func_150910_a(p_77659_1_, p_77659_3_, Storage.H2OCoolJar);
                }

                if (material == Material.lava && l == 0)
                {
                    p_77659_2_.setBlockToAir(i, j, k);
                    return this.func_150910_a(p_77659_1_, p_77659_3_, Storage.LavaJar);
                }
            }
            else
            {
                ...
                {
                    return new ItemStack(Ingredients.GlassJar);
                }
